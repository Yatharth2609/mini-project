        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className='space-y-12'>
                <div className='border-b border-gray-900/10 pb-12'>
                    ...
                    <div className='mt-10 flex flex-col left-y-8'>
                      ...
                      <div>
                        ...
                        <div className='mt-2 flex items-center gap-x-3'>
                            <Image alt='profile photo' width={48} height={48} className='rounded-full' src={image || currentUser?.image || '/images/placeholder.jpg'}/>
